class CarInfo {
  ...
  CarInfo({this.count, this.message, this.searchCriteria, this.results});
...
class Results {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['BlindSpotIntervention'] = this.blindSpotIntervention;
    ...
    data['LaneCenteringAssistance'] = this.laneCenteringAssistance;
    ...
    data['NonLandUse'] = this.nonLandUse;
    data['Note'] = this.note;
    ...
    data['RearAutomaticEmergencyBraking'] = this.rearAutomaticEmergencyBraking;
